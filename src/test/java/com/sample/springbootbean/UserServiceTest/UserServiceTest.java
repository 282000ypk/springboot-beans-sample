package com.sample.springbootbean.UserServiceTest;
...
public class UserServiceTest {
    ...
    public void findUserTest(){
        AppUser user1 = new AppUser(1L,"Product1", "Product Description");
    ...
    public void findUserByNameTest(){
        AppUser user1 = new AppUser(1L,"Product1", "Product Description");
        user1 = userService.createUser(user1);
        AppUser user2 = userService.findByName(user1.getName());
        Assertions.assertNotNull(user2);
    }
